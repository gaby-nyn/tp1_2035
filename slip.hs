...
s2l (Ssym "nil") = Lnil
s2l (Ssym s) = Lref s
s2l (Scons (Ssym "lambda") (Scons(Ssym s) a)) = Llambda s (s2l a)
s2l (Scons (Ssym "call") (Scons s a)) = Lcall (s2l s) (s2l a)
s2l (Scons (Ssym "add") (Scons s a)) = Ladd (s2l s) (s2l a)
s2l (Scons (Ssym "match") (Scons exp1 (Scons (Ssym var1) (Scons (Ssym var2) (Scons exp2 exp3))))) = Lmatch (s2l exp1) var1 var2 (s2l exp2) (s2l exp3)
s2l (Scons (Ssym "fix") (Scons (Ssym "[") (Scons (Ssym var1) (Scons exp1 (Scons (Ssym "]") exp2))))) = Lfix [(var1, s2l exp1)] (s2l exp2)
-- ¡¡ COMPLETER !!
